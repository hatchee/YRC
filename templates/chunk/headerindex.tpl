 ...
 <div class="header" id="homehead">
 	...
 	<div id="slides">
        <div class="slides_container">
            <a href=""><img src="/image/banner/yangtze-cruise-ship2.jpg"></a>
            <a href=""><img src="/image/banner/yangtze-cruise-guide.jpg"></a>
            <a href=""><img src="/image/banner/china-tour.jpg"></a>
        </div>
    </div>
	...
	<option></option>
	<option style="font-size:11px;line-height:15px" value="3">7Days Chongqing→Shanghai</option>
